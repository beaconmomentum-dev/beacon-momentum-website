...
const faq = [
  ...
  ["What does the $250,000 figure mean?", "Beacon Momentum LLC invested more than $250,000 over the last 12 months in infrastructure, systems, content, and delivery capacity. The Watch remains open as a real membership purchase while customer revenue helps carry the next 12 months of delivery. At $497/year, 504 paid annual memberships equal $250,488 in gross first-year receipts. This is arithmetic, not a forecast or an investment target."],
      ...
      <section style={{ padding: "clamp(4rem, 8vw, 7rem) 0", background: C.cream, color: C.deep }}>
        <div className="container" style={{ display: "grid", gridTemplateColumns: "minmax(0, 0.85fr) minmax(0, 1.15fr)", gap: "clamp(2rem, 7vw, 7rem)", alignItems: "start" }}>
          ...
          <div style={{ paddingTop: "0.35rem" }}>
            ...
            <p style={{ margin: "1.4rem 0 0", color: "rgba(7,21,35,0.78)", fontFamily: "Georgia, serif", fontSize: "1.1rem", lineHeight: 1.85 }}>At $497/year, 504 paid annual memberships equal $250,488 in gross first-year receipts. That is transparent operating math, not a demand forecast, a share in the company, or a promise of any financial outcome.</p>
          </div>
        </div>
      </section>
